...
public void insert(int key)
	{
		...
		promote(leaf,key,null);
		 System.out.print("---------------\n");
		try{  
                     File fle = new File("C:\\Users\\Manjunath\\Documents\\NetBeansProjects\\project\\traverse.txt");
		  ...
		  System.out.print("---------------- \n");
                  try{ 
                      FileWriter fw=new FileWriter("C:\\Users\\Manjunath\\Documents\\NetBeansProjects\\project\\traverse.txt",true);
                        fw.write("-----------------\n");
                        fw.close();
                    }
                    catch(Exception e)
...
void traverse(node ptr){
                 ...
                 for(int i = 0; i < ptr.size; i++)
                {
                  ...
                  try{  FileWriter fw=new FileWriter("C:\\Users\\Manjunath\\Documents\\NetBeansProjects\\project\\traverse.txt",true);
                    fw.write(ptr.a[i]+" ");
                    fw.close();
                }
                ...
                try{
                    FileWriter fw=new FileWriter("C:\\Users\\Hemas\\Downloads\\fs_prop\\traverse.txt",true);
...
no1=0;
try {
          File fle = new File("C:\\Users\\Manjunath\\Documents\\NetBeansProjects\\project\\det.txt");
          if (fle.createNewFile()){
            System.out.println("File is created!");
            }else{
            System.out.println("File already exists.");
...
BufferedReader reader = new BufferedReader(new FileReader("C:\\Users\\Manjunath\\Documents\\NetBeansProjects\\project\\det.txt"));
String line;
